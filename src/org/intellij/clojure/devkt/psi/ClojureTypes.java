...
import org.intellij.clojure.devkt.lang.ClojureNodeType;
import org.intellij.clojure.devkt.lang.ClojureTokenType;
import org.intellij.clojure.devkt.psi.impl.*;
...
public interface ClojureTypes {
	...
	class Factory {
		...
		public static CompositePsiElement createElement(IElementType type) {
			...
			} else throw new AssertionError("Unknown element type: " + type);
		}
	}
}
