...
object ClojureConstants {
	...
	@JvmStatic
	val CLJ_CORE_PATH = "/clojure/core.clj"
	@JvmStatic
	val CLJS_CORE_PATH = "/cljs/core.cljs"
	...
	val NS_USER = "user"
	@JvmStatic
	val NS_SPEC = "clojure.spec"

	@JvmStatic
	val CLOJURE_CORE = "clojure.core"
	@JvmStatic
	val CLJS_CORE = "cljs.core"
	@JvmStatic
	val CORE_NAMESPACES = hashSetOf(CLOJURE_CORE, CLJS_CORE)

	@JvmStatic
	val SYMBOLIC_VALUES = hashSetOf("Inf", "-Inf", "NaN")

	@JvmStatic
	val SPECIAL_FORMS = "\\s+".toRegex().split("""
    def if do quote var
    recur throw
    try catch finally
	...
	@JvmStatic
	val CONTROL_SYMBOLS = "\\s+".toRegex().split("""
    fn if do let loop
    try catch finally
	...
	@JvmStatic
	val DEF_ALIKE_SYMBOLS = "\\s+".toRegex().split("""
	...
	@JvmStatic
	val FN_ALIKE_SYMBOLS = "\\s+".toRegex().split("""fn fn* rfn""").toSet()

	@JvmStatic
	val LET_ALIKE_SYMBOLS = "\\s+".toRegex().split("""
	...
	@JvmStatic
	val CLJS_TYPES = "\\s+".toRegex().split("""
    default nil object boolean number string array function
    """.trim()).toSet()

	// java specific
	@JvmStatic
	val J_OBJECT = "java.lang.Object"
	@JvmStatic
	val J_CLASS = "java.lang.Class"
	@JvmStatic
	val J_READER = "java.io.Reader"
	@JvmStatic
	val J_WRITER = "java.io.Writer"
	@JvmStatic
	val C_VAR = "clojure.lang.Var"
	@JvmStatic
	val C_NAMESPACE = "clojure.lang.Namespace"

}

object ClojureIcons {
	@JvmStatic
	val CLOJURE_ICON = IconLoader.getIcon("/icons/clojure.png")
	@JvmStatic
	val NAMESPACE = IconLoader.getIcon("/icons/namespace.png")
	@JvmStatic
	val SYMBOL = IconLoader.getIcon("/icons/symbol.png")
}
